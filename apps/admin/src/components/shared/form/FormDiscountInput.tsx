          ...
          <div className="space-y-2 w-full">
            <FormControl>
              <div className="relative">
                <div className="absolute top-0 left-0 border-r border-r-input h-12 w-14 text-lg rounded-l-md overflow-hidden">
                  <div
                    className={cn(
                      "flex flex-col h-24 w-14 duration-500",
                      isPercentage && "-translate-y-12"
                    )}
                  >
                    <span className="h-12 w-14 grid place-items-center flex-shrink-0 text-xs font-bold">
                      XAF
                    </span>
                    <span className="h-12 w-14 grid place-items-center flex-shrink-0">
                      %
                    </span>
                  </div>
                </div>
