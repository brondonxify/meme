...
export default function StatusOverview({ stats }: StatusOverviewProps) {
  ...
  const pendingCount = ordersByStatus.find(o => o.status === 'pending')?.count || 0;
  const processingCount = ordersByStatus.find(o => o.status === 'processing')?.count || 0;
  const deliveredCount = ordersByStatus.find(o => o.status === 'delivered')?.count || 0;

  const cards: DashboardCard[] = [
    {
      icon: <HiOutlineShoppingCart />,
      title: "Total Orders",
      value: stats ? String(stats.totalOrders) : "815",
      className:
    ...
    },
    {
      ...
      value: stats ? String(pendingCount) : "263",
      className:
    ...
    },
    {
      ...
      value: stats ? String(processingCount) : "97",
      className:
    ...
    },
    {
      ...
      value: stats ? String(deliveredCount) : "418",
      className:
